    ...
    var b = {init: function (e) {
            ...
            return this.each(function () {
                ...
                if (e.advanced.updateOnBrowserResize) {
                    ...
                    c(window).on("resize." + m.data("mCustomScrollbarIndex"), function () {
                        if (i) {
                            clearTimeout(i)
                        }
            ...
            if (!l.data("bindEvent_scrollbar_drag")) {
                ...
                if (c.support.pointer || c.support.msPointer) {
                    ...
                    c(document).on(z + "." + l.data("mCustomScrollbarIndex"), function (K) {
                        K.preventDefault();
                        if (l.data("on_drag")) {
                            var J = k, M = J.offset(), I = K.originalEvent.pageX - M.left, L = K.originalEvent.pageY - M.top;
                            G(o, p, L, I)
                        }
                    }).on(e + "." + l.data("mCustomScrollbarIndex"), function (x) {
                        l.data({on_drag: false});
                        k.removeClass("mCSB_dragger_onDrag")
                    })
                } else {
                    k.on("mousedown touchstart", function (K) {
                        K.preventDefault();
                    ...
                    c(document).on("mousemove." + l.data("mCustomScrollbarIndex"), function (K) {
                        if (l.data("on_drag")) {
                            var J = k, M = J.offset(), I = K.pageX - M.left, L = K.pageY - M.top;
                            G(o, p, L, I)
                        }
                    }).on("mouseup." + l.data("mCustomScrollbarIndex"), function (x) {
                        l.data({on_drag: false});
                        k.removeClass("mCSB_dragger_onDrag")
                    })
                }
            ...
            if (l.data("scrollButtons_enable")) {
                if (l.data("scrollButtons_scrollType") === "pixels") {
                    if (l.data("horizontalScroll")) {
                        w.add(D).off("mousedown touchstart MSPointerDown pointerdown mouseup MSPointerUp pointerup mouseout MSPointerOut pointerout touchend", j, h);
                        ...
                        f.add(A).off("mousedown touchstart MSPointerDown pointerdown mouseup MSPointerUp pointerup mouseout MSPointerOut pointerout touchend", j, h);
                        l.data({bindEvent_buttonsContinuous_y: false});
                        if (!l.data("bindEvent_buttonsPixels_y")) {
                            f.on("click", function (x) {
                                x.preventDefault();
                    ...
                    if (l.data("horizontalScroll")) {
                        ...
                        if (!l.data("bindEvent_buttonsContinuous_x")) {
                            w.on("mousedown touchstart MSPointerDown pointerdown", function (y) {
                                y.preventDefault();
                                var x = B();
                            ...
                            w.on("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout", j);
                            D.on("mousedown touchstart MSPointerDown pointerdown", function (y) {
                                y.preventDefault();
                                var x = B();
                            ...
                            D.on("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout", h);
                        ...
                        if (!l.data("bindEvent_buttonsContinuous_y")) {
                            f.on("mousedown touchstart MSPointerDown pointerdown", function (y) {
                                y.preventDefault();
                                var x = B();
                            ...
                            f.on("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout", u);
                            A.on("mousedown touchstart MSPointerDown pointerdown", function (y) {
                                y.preventDefault();
                                var x = B();
                            ...
                            A.on("mouseup touchend MSPointerUp pointerup mouseout MSPointerOut pointerout", g);
        ...
        , stop: function () {
            ...
            f.off("mousewheel focusin mouseenter mouseleave touchend");
            h.off("touchstart touchmove");
            if (e) {
            ...
            c(document).off("mousemove." + e.data("mCustomScrollbarIndex") + " mouseup." + e.data("mCustomScrollbarIndex") + " MSPointerMove." + e.data("mCustomScrollbarIndex") + " MSPointerUp." + e.data("mCustomScrollbarIndex"));
            c(window).off("resize." + e.data("mCustomScrollbarIndex"))
